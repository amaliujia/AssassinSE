...
public class QueryWriter {
    ...
    private static double url = 0.0;
    private static double keywords = 0.0;
    private static double body = 0.3;
    private static double title =0.3;
    private static double inlink = 0.2;

    private static double w1 = 0.1;
    private static double w2 = 0.9;
    ...
    private static void multireprentationModel(FileWriter fileWriter) throws IOException{
    ...
    private static void sequentialModel(FileWriter fileWriter) throws IOException{
